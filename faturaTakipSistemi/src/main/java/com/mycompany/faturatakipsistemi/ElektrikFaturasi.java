...
public class ElektrikFaturasi extends Fatura {
    ...
    public ElektrikFaturasi(String musteriAdi, double faturaTutari, LocalDate sonOdemeTarihi) {
    ...
    public void gecikmeZammiHesapla() throws Exception {
        if (gecikmedeMi()) {
            double gecikmeZammi = faturaTutari * 0.05; // %5 gecikme zammı
            faturaTutari += gecikmeZammi;
            System.out.println("Elektrik Faturasina Gecikme Zammi Uygulandi: " + gecikmeZammi);
            gecikmeVarMi = true;
            indirimHesapla();
            ...
            System.out.println("Elektrik Faturasina Gecikme Zammi Uygulanmadi.");
            gecikmeVarMi = false;
            indirimHesapla();
        }
    }
    ...
    public void indirimHesapla() {
        ...
        if (faturaTutari>60 && gecikmeVarMi==false) {
